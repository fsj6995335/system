...
export const SYSTEM_ROLES: { value: SystemRole; label: string; description: string }[] = [
  { value: "boss", label: "老板", description: "所有权限，可查看AI分析和数据大屏" },
  { value: "director", label: "总监", description: "部分权限，无删除权限，可查看AI分析" },
  { value: "shareholder", label: "股东", description: "只能查看数据，无操作权限" },
  { value: "leader", label: "组长", description: "查看本组员工数据和公司排名" },
  { value: "finance", label: "财务", description: "财务相关权限" },
  { value: "employee", label: "员工", description: "基本操作，可查看排名" },
];
...
export const ROLE_PERMISSIONS: Record<SystemRole, Permission[]> = {
  ...
  leader: [
    ...
    "view_rankings", "use_ai_assistant", "use_ai_video", "view_team_data",
  ],
  finance: [
    "view_dashboard", "view_credit_reports", "view_customers", "view_bank_products",
    "view_disbursements", "manage_disbursements", "view_rankings", "use_ai_assistant",
    "view_all_data",
  ],
  employee: [
    "view_dashboard", "view_credit_reports", "upload_credit_report", "view_customers",
    "view_bank_products", "view_disbursements", "view_rankings", "use_ai_assistant",
    "use_ai_video",
  ],
};
